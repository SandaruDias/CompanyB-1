...
import PrototypesPage from "./PrototypeTable";
import SimulationsTable from "./simulationTable";
import UpdatePage from "./managerDash";
...
export default function Dashboard() {
  ...
  const sideList = () => (
    <Box className={classes.menuSliderContainer} component="div">
      ...
      <List>
        {[
          { Icon: DashboardIcon, text: "Prototypes" },
          { Icon: AssignmentInd, text: "Simulations" },
          { Icon: PersonIcon, text: "Updates" },
