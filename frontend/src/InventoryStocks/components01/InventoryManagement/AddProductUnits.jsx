  ...
  const handleUpdateUnits = async () => {
    try {
      ...
      const response = await axios.post(
        `http://localhost:8090/product/add-units`,
        {
          id: selectedProduct,
      ...
      console.log("Units added successfully", response.data);
      ...
      setResponseMessage("Failed to add units!");
      setModalVisible(true);
    }
  };
  ...
  return (
    ...
    <NavBar></NavBar>
      ...
      >
        ...
        <button onClick={handleUpdateUnits} className="update-button">
          Add Units
        </button>
      </div>
      <Modal
